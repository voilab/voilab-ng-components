            ...
            link: function (scope, element, attrs) {
                var expand_all_parents,
                    ...
                    activate = function () {
                        ...
                        if (!attrs.iconLoad) {
                            attrs.iconLoad = 'fa fa-circle-o-notch fa-spin';
                        }
                        ...
                        if (!lodash.isArray(scope.treeData)) {
                ...
                init_control = function () {
                    if (!lodash.isObject(scope.treeControl)) {
                        return;
                    }
                    ...
                    tree.get_row = function (branchId) {
                        return lodash.find(scope.tree_rows, ['branch.uid', branchId]);
                    };
